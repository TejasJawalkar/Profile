const experiences = [
  {
    ...
    description: [
      "Learned and contributed to web application development using .NET Core and C#, including SQL query optimization.",
  ...
  },
  {
    ...
    description: [
      ...
      "Built responsive AngularJS front-end components with TypeScript for real-time data visualization.",
      "Designed and integrated Crystal Reports for dynamic reporting.",
      "Optimized SQL queries and execution plans to improve system performance.",
